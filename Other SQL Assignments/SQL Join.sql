...
#Task 1
SELECT o.order_id, p.name, p.product_id, oi.quantity, oi.unit_price
FROM orders o
...
#Task 3
#Connect order item and order item notes table, and display all columns.
SELECT oi.*, oin.*
FROM order_items oi
JOIN order_item_notes oin on oi.order_id = oin.order_id;

#Task 4
#List customer id, customer name, order id of all orders, and sort by customer id
...
#Task 5
#List customer id, customer name, order id of all customers, and sort by customer id
SELECT c.customer_id, c.first_name, c.last_name, o.order_id
FROM customers c
...
#Task 6
#List customer id, customer name, order id, shipper name 
#of all orders, and sort by customer id
